...
namespace GraphicalProgramSamish
{
    public partial class Form1 : Form
    {
        ...
        private void loadToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                textBoxCmd.Text = File.ReadAllText(of.FileName);
            }
        }
        ...
        private void saveToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                System.IO.File.WriteAllText(sv.FileName,textBoxCmd.Text);
            }
        }
        ...
        private void RunButton_Click(object sender, EventArgs e)
        {
            ...
            Match match2 = regex2.Match(textBoxCmd.Text.ToLower());
            Match match3 = regex3.Match(textBoxCmd.Text.ToLower());
            Match match4 = regex4.Match(textBoxCmd.Text.ToLower());

            Match matchClear = regexClear.Match(textBoxCmd.Text.ToLower());
            Match matchReset = regexReset.Match(textBoxCmd.Text.ToLower());
            Match matchMT = regexMT.Match(textBoxCmd.Text.ToLower());

            Match matchR = regexR.Match(textBoxCmd.Text.ToLower());
            Match matchC = regexC.Match(textBoxCmd.Text.ToLower());
            Match matchT = regexT.Match(textBoxCmd.Text.ToLower());
